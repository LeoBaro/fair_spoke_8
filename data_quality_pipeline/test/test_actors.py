...
def test_unimodal_text_filter_actor(ray_init, get_config_path, log_folder, webdataset_output_folder, tar_files):
...
def test_unimodal_vision_filter_actor(ray_init, get_config_path, log_folder, webdataset_output_folder, tar_files):
    
    unimodalVisionFilter = UnimodalVisionFilter.options(
        name="UnimodalVisionFilter",
        num_gpus=1,
        max_concurrency=1
    ).remote(get_config_path(), log_folder, webdataset_output_folder)
...
def test_ray_multimodal_filtering(ray_init, tar_files, log_folder, webdataset_output_folder, get_config_path):
...
def test_ray_multimodal_specificity_filtering(ray_init, tar_files, log_folder, webdataset_output_folder, get_config_path):
